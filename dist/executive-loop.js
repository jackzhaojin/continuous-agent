...
import { validateAuth } from './worker-spawner.js';
 ...
 */
function logHealthStatus(health) {
 ...
 */
function isHealthyEnoughToWork(health) {
 ...
 */
async function validateWork(item, result) {
 ...
 */
async function updateState(item, success) {
...
//# sourceMappingURL=executive-loop.js.map