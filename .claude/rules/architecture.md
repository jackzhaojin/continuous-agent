...
**GitHub Pages CI:** `ai-sandbox/.github/workflows/deploy-pages.yml` auto-deploys all Vite projects on push to main. Live at [jackzhaojin.github.io/ai-sandbox](https://jackzhaojin.github.io/ai-sandbox/).
