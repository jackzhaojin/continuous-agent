...
| 5 | [Worker Prompt System](05-worker-prompts.md) | `src/agentic/worker-prompts/` |
...
The executive layer (Claude) orchestrates and reasons. The worker layer (Claude, Codex, or Kimi K2.5) writes code. Prompts are versioned markdown. Skills are declarative. The whole system is a coding agent that treats LLMs as interchangeable coding engines behind a unified interface.
