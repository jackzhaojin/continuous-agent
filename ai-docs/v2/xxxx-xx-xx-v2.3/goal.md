# V2.3 Goal: Migrate Ledgers & AI State to Cloud Database
...
Medium-High — this is foundational infrastructure that unblocks better observability, reliability, and multi-machine operation.
