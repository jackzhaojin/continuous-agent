...
The hosting decision record (`2026-05-15-second-brain-hosting-decision.md`) is decided. Three implementation pillars are now locked and override any contrary draft in that file:
